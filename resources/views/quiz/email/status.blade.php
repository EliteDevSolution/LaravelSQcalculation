...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_6">
            <h4>Dear <?php echo $group->name;?>, </h4>
            <p>
            	<span style="color: #ffffff; float: left; font-size: 35px; line-height: 20px; padding: 15px; margin-right: 5px; background-color: #74cee4;">H</span>
            	ello!, an email was sent to the group's members but the follow list didn't receive the welcome email.
                <ul>
                ...
                <table class="nicdark_table extrabig nicdark_bg_blue nicdark_radius ">
                    ...
                    <tbody class="nicdark_bg_grey nicdark_border_grey">
                        <tr>
                            ...
                            <td><p><?php echo $group->start_date; ?> to <?php echo $group->end_date; ?></p></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><p>created by <a mailto="<?php echo $group->email;?>"><?php echo $group->email;?></a></p></td>
                        </tr>
                        <tr>
                            <td>
                            	<a href="#" class="nicdark_btn_icon nicdark_bg_green small nicdark_radius_circle white">
