    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_blue nicdark_bg_bluedark_hover nicdark_transition nicdark_radius nicdark_shadow">
                <div class="after-quiz nicdark_margin20 nicdark_relative">
                    <a href="#" class="button nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_bluedark medium nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i>1</i></a>

                    <div class="content nicdark_activity nicdark_marginleft70 nicdark_disable_marginleft_ipadpotr">
        ...
        <div class="grid grid_4">
            <div class="nicdark_archive1 nicdark_bg_green nicdark_bg_greendark_hover nicdark_transition nicdark_radius nicdark_shadow">
                <div class="after-quiz nicdark_margin20 nicdark_relative">
                    <a href="#" class="button nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_greendark medium nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i>2</i></a>
        ...
        <div class="grid grid_4">
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_bg_yellowdark_hover nicdark_transition nicdark_radius nicdark_shadow">
                <div class="after-quiz nicdark_margin20 nicdark_relative">
                    <a href="#" class="button nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_yellowdark medium nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i>3</i></a>
		...
		<div class="text-center grid grid_12 nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
			<a href="<?php echo action('QuizController@index'); ?>" class=" nicdark_btn nicdark_bg_green medium nicdark_shadow nicdark_radius white nicdark_press"> <i class="icon-left-open-outline"></i> &nbsp;&nbsp;&nbsp;CREATE YOUR OWN QUIZ</a>
		</div>
		<div class="nicdark_space50"></div>
    </div>
    <!--end nicdark_container-->
